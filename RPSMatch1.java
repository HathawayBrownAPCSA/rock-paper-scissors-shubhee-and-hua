...
/**
 * Runs a rock paper scissors match(will play human's previous move msot of the time)
 *
 * @Shubhee @Hua
 * @version 20211006
 */
public class RPSMatch1
{
    //variables
    ...
    /**Constructor for RPSMatch1
     * @param humanScore, computerScore, ties
     */
    public RPSMatch1(int hW, int cW, int t)
    {
       humanWins = hW;
       computerWins = cW;
       ties = t;
